...
// It uses Firefox's local storage to keep a record of the total duration watched and the actual time spent watching videos for each day.
...
function initializeStorage() {
    browser.storage.local.get(['videoWatchHistory']).then((result) => {
        ...
        if (!videoWatchHistory[today]) {
            ...
            browser.storage.local.set({videoWatchHistory: videoWatchHistory});
